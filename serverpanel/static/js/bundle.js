...
/***/ function(module, exports, __webpack_require__) {
	...
	var _panel = __webpack_require__(224);

	var _panel2 = _interopRequireDefault(_panel);

	var _network = __webpack_require__(237);
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.cloneElement(this.props.children, this.props.route),
	...
	var router = _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: Main, url: document.getElementById('panel').getAttribute('url') },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _panel2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/network/', component: _network2.default })
	    )
	);

	(0, _reactDom.render)(router, document.getElementById('panel'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hostname = __webpack_require__(226);

	var _hostname2 = _interopRequireDefault(_hostname);

	var _uptime = __webpack_require__(227);

	var _uptime2 = _interopRequireDefault(_uptime);

	var _memory = __webpack_require__(229);

	var _memory2 = _interopRequireDefault(_memory);

	var _swap = __webpack_require__(231);

	var _swap2 = _interopRequireDefault(_swap);

	var _disk = __webpack_require__(232);

	var _disk2 = _interopRequireDefault(_disk);

	var _processes = __webpack_require__(233);

	var _processes2 = _interopRequireDefault(_processes);

	var _pihole = __webpack_require__(234);

	var _pihole2 = _interopRequireDefault(_pihole);

	var _networkExternal = __webpack_require__(235);

	var _networkExternal2 = _interopRequireDefault(_networkExternal);

	var _networkInternal = __webpack_require__(236);
	                ...
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-lg-3' },
	                            _react2.default.createElement(_logo2.default, { url: this.state.data.system.temp, pollInterval: 1000 })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-lg-9' },
	        ...
	        value: function loadFromServer() {
	            ...
	            $.ajax({
	                ...
	                success: function success(data) {
	                    ...
	                    _this2.setState({ data: data, color: color });
	                },
	                error: function error(xhr, status, err) {
	                    console.error(_this2.props.url, status, err.toString());
	                }
	    ...
	    _createClass(Memory, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_progressbar2.default, { used: this.state.data.used, total: this.state.data.total, free: this.state.data.free, percent: this.state.data.percent })
	            );
	        }
	    }]);
